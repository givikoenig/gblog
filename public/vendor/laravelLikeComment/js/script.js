...
$(document).on('submit', '.laravelComment-form', function(){
    ...
    $.ajax({
      ...
      .fail(function(msg){
        ...
        .fadeIn(500)
        .css('display','flex')
        .text('Превышена допустимая длина сообщения (500 знаков)')
        .delay(2000)
        .fadeOut(500);
        // alert('Превышена допустимая длина сообщения (500 зн.)');
      });
